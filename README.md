# Bheema Universal Central School — Website (Sindagi)

- **Live:** https://shreekantha3.github.io/sindagi-bheema-universal-central-school/
- **Repo:** `shreekantha3/sindagi-bheema-universal-central-school` (branch `main` = source, `gh-pages` = deployed bundle where applicable)
- **Stack:** static Vite + Tailwind CSS, no backend. `base: '/sindagi-bheema-universal-central-school/'` for GitHub Pages project-site hosting.
