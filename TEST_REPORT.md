# TEST REPORT — Bheema Universal Central School
> Tester: Senior Engg | Segment: School | Tier-3
...
- Maps URL + JSON-LD School schema + H1 with business name
- No lorem ipsum, no invented hours/prices/ratings

## Build result (2026-09-15)
- [x] `npm run build` PASS (vite 5.4.21, 0 warnings)
- dist: index 13.79 kB / CSS 11.63 kB / JS 1.17 kB — under perf budget (<200KB JS, <1.5MB total)
